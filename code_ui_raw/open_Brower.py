...
class Ui_OpenBrower(object):
    def setupUi(self, OpenBrower):
        ...
        self.lineEdit_text_input = QtWidgets.QLineEdit(OpenBrower)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.lineEdit_text_input.setFont(font)
        self.lineEdit_text_input.setText("")
        self.lineEdit_text_input.setObjectName("lineEdit_text_input")
    ...
    def retranslateUi(self, OpenBrower):
        ...
        self.lineEdit_text_input.setPlaceholderText(_translate("OpenBrower", "USERNAME PASSWORD PROXY"))

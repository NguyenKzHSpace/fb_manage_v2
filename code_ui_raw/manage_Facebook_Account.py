...
class Ui_Manage_Facebook_Account(object):
    def setupUi(self, Manage_Facebook_Account):
        ...
        self.checkBox_filter_proxy = QtWidgets.QCheckBox(self.groupBox_9)
        self.checkBox_filter_proxy.setText("")
        self.checkBox_filter_proxy.setObjectName("checkBox_filter_proxy")
        self.horizontalLayout_7.addWidget(self.checkBox_filter_proxy)
        self.lineEdit_filter_proxy = QtWidgets.QLineEdit(self.groupBox_9)
        self.lineEdit_filter_proxy.setObjectName("lineEdit_filter_proxy")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1145, 420))
        ...
        self.scrollAreaWidgetContents_statistics.setGeometry(QtCore.QRect(0, 0, 1125, 165))
    ...
    def retranslateUi(self, Manage_Facebook_Account):
        ...
        self.groupBox_9.setTitle(_translate("Manage_Facebook_Account", "Filter by proxy"))
        self.lineEdit_filter_proxy.setPlaceholderText(_translate("Manage_Facebook_Account", "Enter the Name"))
